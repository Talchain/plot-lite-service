...
describe('Template: feature_rollout_phased_learning', () => {
  ...
  it('Test 1: Shape & v1.2 fields', async () => {
    const res = await fetch(`${baseUrl}/v1/templates/feature_rollout_phased_learning/graph`);
  ...
  it('Test 2: Determinism', async () => {
    const graphRes = await fetch(`${baseUrl}/v1/templates/feature_rollout_phased_learning/graph`);
