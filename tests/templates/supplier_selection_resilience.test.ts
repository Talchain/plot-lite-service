...
describe('Template: supplier_selection_resilience', () => {
  ...
  it('Test 1: Shape & v1.2 fields', async () => {
    const res = await fetch(`${baseUrl}/v1/templates/supplier_selection_resilience/graph`);
  ...
  it('Test 2: Determinism', async () => {
    const graphRes = await fetch(`${baseUrl}/v1/templates/supplier_selection_resilience/graph`);
