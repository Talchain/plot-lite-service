 ...
 * tests/fixtures/isl-v2-live-20260707/isl-staging-capture.json (capture
 * method: that directory's PROVENANCE.md).
 ...
 *  - FIXTURE points at this repo's raw capture (the olumi-schemas mirror
...
const FIXTURE = join(here, '..', 'fixtures', 'isl-v2-live-20260707', 'isl-staging-capture.json');

const isl: Record<string, unknown> = JSON.parse(readFileSync(FIXTURE, 'utf-8'));
