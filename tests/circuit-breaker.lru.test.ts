...
describe('PR-2B: BoundedLRU for Principals', () => {
  ...
  beforeEach(async () => {
    ...
    process.env.PRINCIPAL_HMAC_SECRET = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'; // PR-3: 64-char test secret: Required for per-principal tracking
