 ...
 * @param {string} endpoint - e.g., 'run', 'critique'
...
export function validateRequest(endpoint, payload) {
  ...
  // '/v1/counterfactual' was removed here when the route was WITHDRAWN (typed 501,
  // ROADMAP 2.105): it refuses before validation, so no input is valid for it.
  if (endpoint === 'run') {
