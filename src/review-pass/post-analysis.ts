 ...
 * - Sort: (priority ASC, card_type bytewise ASC, card_id bytewise ASC)
 * - Higher-priority cards (lower number) sort first
...
import { REVIEW_PASS_SCHEMA_VERSION, lookupBand } from './types.js';
