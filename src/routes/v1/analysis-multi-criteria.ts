/**
 * POST /v1/analysis/multi-criteria — WITHDRAWN (typed 501 refusal).
 *
 ...
 *   per-criterion option ranks were decided by array position; the criterion dimension was genuine, the option dimension was not.
 *
