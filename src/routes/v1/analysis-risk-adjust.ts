/**
 * POST /v1/analysis/risk-adjust — WITHDRAWN (typed 501 refusal).
 *
 ...
 *   original_rank/adjusted_rank flipped on a pure reorder while the scores stayed byte-identical, and rankings_changed still reported false.
 *
