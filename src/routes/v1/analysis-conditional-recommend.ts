/**
 * POST /v1/analysis/conditional-recommend — WITHDRAWN (typed 501 refusal).
 *
 ...
 *   the named winner flipped on a pure reorder with identical scores; the route's own output said "0% lower expected value".
 *
