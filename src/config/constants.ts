...
// Service-level graph limits exposed via /v1/limits (SSOT for docs/SDK)
export const LIMITS_MAX_NODES = Number(process.env.GRAPH_MAX_NODES || 50);
export const LIMITS_MAX_EDGES = Number(process.env.GRAPH_MAX_EDGES || 200);
